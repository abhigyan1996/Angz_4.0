...
var _positions = [
  {
    name: 'jonathan', 
   	start: {
    	percent: 0.1, x: 0.1, y: 0.03
  	},
    end: {
      percent: 0.8, x: 0.03, y: 0.1
    }
  },
    {
    name: 'harry', 
    start: {
      percent: 0.3, x: 0.02, y: 0.05
    },
    end: {
      percent: 0.8, x: 1.2, y: 0.1
    }
  },
  {
    name: 'building1', 
    start: {
      percent: 0.3, x: 0.01, y: 0.05
    },
    end: {
  ...
  },
  {
    name: 'lightning', 
    start: {
      percent: 0.1, x: 0.4, y: 0.002
    },
    end: {
      percent: 0.8, x: 0.09, y: 0.1
    }
  },
  {
    name: 'stars', 
    start: {
      percent: 0.1, x: 0.2, y: 0.05
    },
    end: {
